...
// @Component({
//     selector: 'app-pagination',
//     template: `<nav><ul class="pagination"> <li class="page-item"><a class="page-link waves-effect" (click)="navigateBack()"><span aria-hidden="true">«</span> <span class="sr-only">Previous</span></a></li>
...
//     ngOnInit() {
//         /* console.log(this.pages); this.firstPage = this.pages[0];
...
// /** * Class representing the Pagination */ export class Page {
//     public isActive: boolean; public pageNumber: number; public rowsToDisplay: number; public previousRowCount: number;
